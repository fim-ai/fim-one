...
function SidebarNewChat({ collapsed }: { collapsed: boolean }) {
  ...
  if (collapsed) {
    return (
      <div className="flex flex-col items-center gap-0.5 px-2 py-1 shrink-0">
  ...
  return (
    <div className="px-3 py-1 shrink-0">
      ...
      <button
        onClick={() => setSearchOpen(true)}
        className="group flex w-full items-center gap-2 rounded-md px-2 py-1 text-[13px] transition-colors text-muted-foreground hover:bg-accent/50 hover:text-accent-foreground"
      >
...
function SidebarNav({ collapsed }: { collapsed: boolean }) {
  ...
  return (
    <div className={cn("px-3 py-1 shrink-0", collapsed && "flex flex-col items-center gap-0.5")}>
