"""Adapter that converts ConnectorActions into FIM One tools."""
...
CONNECTOR_RESPONSE_MAX_ITEMS = int(os.environ.get("CONNECTOR_RESPONSE_MAX_ITEMS", "10"))
    ...
    async def run(self, **kwargs: Any) -> str:
        ...
        try:
            async with get_safe_async_client(timeout=30) as client:
                ...
                if self._response_extract and resp.headers.get(
                    "content-type", ""
        ...
        for key, value in params.items():
            ...
            if isinstance(value, str):
                ...
                escaped = json.dumps(value)[
                    1:-1
                ]  # JSON-escaped interior without surrounding quotes
