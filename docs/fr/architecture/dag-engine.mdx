...
title: "Moteur DAG"
icon: "code-branch"
description: "Fonctionnement du moteur DAG de FIM One — planification dynamique, exécution parallèle, analyse orientée vers les objectifs et replanification autonome."
mode: "wide"
---

Pour comprendre comment ce moteur se rapporte à l'**ingénierie graphique** industrielle, aux workflows visuels classiques et à la boucle ReAct, consultez [Planning Landscape](/architecture/planning-landscape).
