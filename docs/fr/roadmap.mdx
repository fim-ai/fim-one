...
### v0.9 — Partage en toute sécurité

**Objectif** : un connecteur de base de données peut être transmis à un collègue
en toute sécurité, le fait de le récupérer permet réellement de le récupérer, et les
parcours à moitié terminés déjà présents dans l’arborescence sont enfin finalisés.
