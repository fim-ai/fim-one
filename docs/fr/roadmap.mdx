...
- [ ] Replan DAG incrémental : conserver les étapes terminées entre les tours de replan ; persister l'état des étapes pour la reprise au milieu du DAG {/* dev: dev/incremental-dag.md */}
