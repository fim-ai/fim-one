...
#### Cache d'invite + suites de raisonnement {/* dev: dev/prompt-cache-followups.md */}

- [ ] Adaptateur Gemini Context Cache (cycle de vie de cache REST séparé vs marqueur inline Anthropic)
- [ ] Expansion du registre d'invite vers planificateur / vérificateur / classificateur de domaine / compact
