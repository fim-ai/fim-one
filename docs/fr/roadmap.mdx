...
- [x] Les listes de modèles d'administration prennent en charge la multi-sélection par cases à cocher avec plages Shift-clic et suppression en masse en une seule requête

#### Robustesse du contexte

- [x] Discipline du tableau de planification : répétition et rappels sans plan, et la finalisation avec les éléments de plan ouverts force maintenant un passage de vérification
