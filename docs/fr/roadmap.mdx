...
#### Renforcement de l'authentification et de la sécurité
...
- [x] La comparaison d'horodatage de déconnexion forcée normalise les valeurs sensibles/insensibles au fuseau horaire en UTC par conversion — les jetons révoqués sont fiablement rejetés sur SQLite et PostgreSQL
...
- [x] ~~Garde-fous de contenu v0 (détecteur de tripwire entrée/sortie, détecteur de jailbreak, config var env, événement SSE `guardrail_tripwired`)~~ *(livré en v0.8.7)*
