...
- [ ] Modèle d'accès à la facturation — l'instance choisit pas d'abonnements / inclus+payant / payant uniquement, de sorte que l'auto-hébergement, SaaS et la facturation dès le premier jour restent distincts {/* dev: dev/billing-access-model.md */}
