...
- [x] Les modèles OpenAI adoptent d'abord Responses-API — GPT-5.x exécute les outils et le raisonnement ensemble ; les endpoints sans `/v1/responses` reviennent aux complétions de chat
- [ ] Vérifier les chiffres d'utilisation du streaming Responses-bridge lors de la prochaine mise à jour de LiteLLM (mauvais mappage en amont suspecté)
