...
- [x] GPT-5.x passe en Responses-API-first (outils + raisonnement ensemble ; 404 bascule vers les complétions de chat) ; les autres familles restent sur les complétions par conception
- [x] GPT-5.x conserve son raisonnement entre les tours d'outils — `/v1/responses` natif avec relecture du raisonnement chiffré, `FIM_GPT5_RESPONSES_MODE` pour revenir en arrière
