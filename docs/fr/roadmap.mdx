...
- [x] GPT-5.x adopte d'abord l'API Responses (outils + raisonnement ensemble ; 404 bascule vers les complétions de chat) ; les autres familles restent sur les complétions par conception
- [ ] Vérifier les chiffres d'utilisation du streaming Responses-bridge lors de la prochaine mise à niveau de LiteLLM (mauvais mappage en amont suspecté)
