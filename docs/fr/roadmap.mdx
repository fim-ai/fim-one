...
- [x] Commande slash `/clear` démarre une nouvelle conversation depuis la zone de saisie
- [x] Les listes de modèles d'administration supportent la multi-sélection par cases à cocher avec plages Shift-click et suppression en masse en une seule requête
