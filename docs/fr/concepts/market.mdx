...
Les composants sont les intégrations et services d'outils à partir desquels les Solutions sont construites.

| Ressource | Catégorie | Ce que vous obtenez |
|---|---|---|
| **Connector** | Composant | Intégration API/base de données disponible en tant qu'outils d'agent |
| **MCP Server** | Composant | Service d'outils tiers chargé dans les sessions |

<Tip>
Les Knowledge Bases n'apparaissent jamais sur le Market et ne sont jamais souscrites. Un Agent qui utilise une KB délègue le contenu de son propriétaire au moment de l'exécution, donc s'abonner à l'Agent est tout ce dont vous avez besoin.
</Tip>
