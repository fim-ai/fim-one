...
- [ ] Side Query Workers (dedizierte Pools für Recall / Classify / Summary, damit sie nicht um das Haupt-Rate-Limit-Budget konkurrieren)
- [x] Admin LLM Provider Edits apply without process restart (flush LiteLLM client cache on invalidate + 60 s registry TTL safety net)
