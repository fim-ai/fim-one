...
- [x] OpenAI-Modelle verwenden zuerst die Responses-API — GPT-5.x führt Tools und Reasoning zusammen aus; Endpoints ohne `/v1/responses` fallen auf Chat Completions zurück
- [ ] Responses-Bridge-Streaming-Nutzungszahlen beim nächsten LiteLLM-Upgrade überprüfen (Upstream-Fehlzuordnung vermutet)
