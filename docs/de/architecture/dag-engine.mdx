...
Wie diese Engine sich zu Industrie-**Graph-Engineering**, klassischen visuellen Workflows und der ReAct-Schleife verhält, finden Sie unter [Planning Landscape](/architecture/planning-landscape).
