...
- **Sidebar-Logo ist wieder ein echter Link.** Mittlerer Mausklick und Cmd/Strg+Klick öffnen das Dashboard in einem neuen Tab; Linksklick navigiert weiterhin und behält die kurze Bounce-Animation bei.
