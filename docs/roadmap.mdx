...
- [ ] Usage-stat write batching for high-QPS keys (process-local flush-on-shutdown, exact counts, no new dep) — deferred until a measured hotspot {/* dev: dev/public-api-phase2.md */}
