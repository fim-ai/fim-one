...
- [x] Reasoning detail preserved end-to-end — loop streams its genuine final answer (no lossy re-synthesis); reasoning survives compaction, context rebuilds, and sub-agent steps
