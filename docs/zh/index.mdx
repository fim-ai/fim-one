...
<Frame>
  <img src="/banner.jpg" alt="FIM Agent — AI 驱动的连接器枢纽" />
</Frame>

欢迎使用 FIM Agent，这是一个 AI 驱动的框架，用于构建能够在企业各系统间动态规划并执行复杂任务的智能体。

<div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap", marginTop: "0.75rem" }}>
  <a href="https://agent.fim.ai/">官网</a> · <a href="https://github.com/fim-ai/fim-agent">GitHub</a> · <a href="https://discord.gg/z64czxdC7z">Discord</a> · <a href="https://x.com/FIM_Agent">Twitter</a> · <a href="https://www.producthunt.com/products/fim-agent">Product Hunt</a>
</div>
