...
- **The sidebar puts navigation first.** Module navigation now sits above the conversation list with labeled Build / Resources / Operate sections, instead of being tucked into a dock at the bottom of the sidebar.
