...
- **Block actions stay out of the way until you reach for them.** Copy and export buttons on answers, code blocks, diagrams and tables are revealed on hover and share one consistent treatment; they remain reachable by keyboard.
