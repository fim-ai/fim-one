...
- **The browser-tab busy indicator no longer disappears mid-turn.** The favicon now shows a steady busy glyph for the whole run and reliably restores the real icon when the turn ends, even after in-app navigation.
