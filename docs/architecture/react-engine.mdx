---
title: "ReAct Engine"
description: "How FIM Agent's ReAct engine works — dual-mode execution, structured LLM calls, and streaming answer synthesis."
mode: "wide"
---
...
```mermaid
flowchart TD
    A["User query"] --> B["Tool loop\n(non-streaming chat() x N)"]
    B -->|"tool_call"| E["Execute tool"]
    E -->|"observation"| B
    B -->|"done signal"| C["stream_answer()\n(streaming)"]
