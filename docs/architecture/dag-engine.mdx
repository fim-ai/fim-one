...
For how this engine relates to industry **graph engineering**, classic visual workflows, and the ReAct loop, see [Planning Landscape](/architecture/planning-landscape).
